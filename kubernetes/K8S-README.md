...
```
$ docker image tag xamxamkhassida 1234567891993/xamxamkhassida
$ docker push 1234567891993/xamxamkhassida
$ docker image tag chanteur 1234567891993/chanteur
$ docker push 1234567891993/chanteur
```
...
```
$ kubectl get svc xamxamkhassida -n jhipster
```
